...
<table border="0" style="width: 100%; border-collapse: collapse;">
  <tr>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/home-page.png"><img src="docs/screenshots/home-page.png" alt="Home Page" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>🏠 The Grand Entrance (Home)</b></sub>
    </td>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/menu.png"><img src="docs/screenshots/menu.png" alt="Navigation Menu" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>🧭 Elegant Navigation Menu</b></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/category.png"><img src="docs/screenshots/category.png" alt="Category Browsing" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>📂 Intelligent Category Browsing</b></sub>
    </td>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/new-arrival (1).png"><img src="docs/screenshots/new-arrival (1).png" alt="New Arrivals" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>✨ Highlighted New Arrivals</b></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/shop.png"><img src="docs/screenshots/shop.png" alt="Shop Page" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>🛍️ Curated Collections (Shop)</b></sub>
    </td>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/product-page.png"><img src="docs/screenshots/product-page.png" alt="Product Detail" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>🔍 Immersive Discovery (Product Detail)</b></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/cart.png"><img src="docs/screenshots/cart.png" alt="Shopping Cart" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>🛒 Smart Cart System</b></sub>
    </td>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/checkout.png"><img src="docs/screenshots/checkout.png" alt="Secure Checkout" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>💳 Frictionless Checkout</b></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/order-confirm.png"><img src="docs/screenshots/order-confirm.png" alt="Order Confirmation" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>✅ Order Success Confirmation</b></sub>
    </td>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/invoice.png"><img src="docs/screenshots/invoice.png" alt="Invoice" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>🧾 PDF-Ready Invoice Generation</b></sub>
    </td>
  </tr>
</table>
...
<table border="0" style="width: 100%; border-collapse: collapse;">
  <tr>
    <td align="center" width="33%" style="padding: 10px;">
      <a href="docs/screenshots/user-dashboard.png"><img src="docs/screenshots/user-dashboard.png" alt="User Dashboard" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>👤 Personal Style Profile</b></sub>
    </td>
    <td align="center" width="33%" style="padding: 10px;">
      <a href="docs/screenshots/user-orders.png"><img src="docs/screenshots/user-orders.png" alt="User Orders" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>📦 Order History & Tracking</b></sub>
    </td>
    <td align="center" width="33%" style="padding: 10px;">
      <a href="docs/screenshots/user-wishlist.png"><img src="docs/screenshots/user-wishlist.png" alt="User Wishlist" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>❤️ Curated Wishlist</b></sub>
    </td>
  </tr>
</table>
...
<table border="0" style="width: 100%; border-collapse: collapse;">
  <tr>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/admin-dashboard.png"><img src="docs/screenshots/admin-dashboard.png" alt="Admin Dashboard" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>⚙️ Admin Analytics & Management</b></sub>
    </td>
    <td align="center" width="50%" style="padding: 10px;">
      <a href="docs/screenshots/admin-products.png"><img src="docs/screenshots/admin-products.png" alt="Admin Products" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/></a>
      <br/><br/><sub><b>📦 Product Management Panel</b></sub>
    </td>
  </tr>
</table>
